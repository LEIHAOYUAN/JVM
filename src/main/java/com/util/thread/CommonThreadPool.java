...
public final class CommonThreadPool {
    ...
    public static ThreadPoolExecutorExtend getThreadPool(ThreadPoolParameterVO vo) {
        ...
        CommonThreadPool.TaskQueue taskqueue = new CommonThreadPool.TaskQueue(initialCapacity, vo.isDiscard());
        ThreadPoolExecutorExtend executeNew = new ThreadPoolExecutorExtend(corePoolSize, maximumPoolSize, keepAliveTime, TimeUnit.SECONDS, taskqueue, new CommonThreadPool.TaskThreadFactory(threadName), new CommonThreadPool.ThreadPlloRejectedExecutionHandler(vo.isDiscard()));
        ...
        public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
            ...
            if (this.shouldNotReject()) {
                try {
                    ...
                    if (queue instanceof CommonThreadPool.TaskQueue) {
                        reAdd = ((CommonThreadPool.TaskQueue) queue).superOffer(r);
                    } else {
