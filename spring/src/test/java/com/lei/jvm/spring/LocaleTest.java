...
public class LocaleTest {
    ...
    public void testLocale() {
        ...
        log.info("zh_CN=toLanguageTag={}",StringUtils.toLanguageTag(StringUtils.parseLocaleString("zh_CN")));
        log.info("zh-CN=toLanguageTag={}",StringUtils.toLanguageTag(StringUtils.parseLocaleString("zh-CN")));
        log.info("zh-cn=toLanguageTag={}",StringUtils.toLanguageTag(StringUtils.parseLocaleString("zh-cn")));
        log.info("zh_cn=toLanguageTag={}",StringUtils.toLanguageTag(StringUtils.parseLocaleString("zh_cn")));
