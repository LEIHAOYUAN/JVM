...
public final class HTTPRequest {
    ...
    public final Map<String, String> params = MapUtil.newLinkedHashMap();
    public final Map<String, String> headers = MapUtil.newLinkedHashMap();    // make headers/params order deterministic
    public String uri;
    public byte[] body;
    ...
    public void basicAuth(String user, String password) {
        headers.put(HTTPHeaders.AUTHORIZATION, "Basic " + EncodeUtil.base64(user + ':' + password));
    }
    ...
    public void form(Map<String, String> form) {
        ...
        body(StringUtil.bytes(builder.toString()), ContentType.APPLICATION_FORM_URLENCODED);
    }
